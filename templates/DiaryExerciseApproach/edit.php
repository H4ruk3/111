 ...
 * @var string[]|\Cake\Collection\CollectionInterface $diaryExercise
 */
?>
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $diaryExerciseApproach->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $diaryExerciseApproach->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="diaryExerciseApproach form content">
            ...
            <fieldset>
                <legend><?= __('Edit Diary Exercise Approach') ?></legend>
                <?php
