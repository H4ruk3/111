...
/**
 * TrainingprogramdayExerciseFixture
 */
class TrainingprogramdayExerciseFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'trainingprogramday_exercise';
    /**
     * Fields
     *
     * @var array
    ...
    public $fields = [
        ...
        '_indexes' => [
            'trainingprogramday_id' => ['type' => 'index', 'columns' => ['trainingprogramday_id'], 'length' => []],
            'exercise_id' => ['type' => 'index', 'columns' => ['exercise_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'trainingprogramday' => ['type' => 'foreign', 'columns' => ['trainingprogramday_id'], 'references' => ['trainingprogramday', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
